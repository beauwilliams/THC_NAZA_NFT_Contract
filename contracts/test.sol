...
// import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC1155/ERC721.sol";
...
contract THC_NAZA is ERC721, Ownable {
    ...
    uint256 public constant THC_NAZA_SUPPLY = 500;
    uint id = 0;
    // uint tokenId = 0;
    ...
    function _mintGenesis(address _to) public returns (uint) {
        // uint id = randomIndex();
